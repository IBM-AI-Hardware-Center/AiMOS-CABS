...
export JOB_CONFIG="1x1gpu" #batch size 2
...
export START_EVAL_AT=500
export EVALUATE_EVERY=20
export LEARNING_RATE="0.8"
export LR_WARMUP_EPOCHS=200
export DATASET_DIR="/home/neil/workdev/datasets/kits/data"
...
export USE_TB=0
export TPN=1
export SLURM_JOB_NAME=Ceres-Test
